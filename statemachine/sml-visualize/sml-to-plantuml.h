...
#ifndef SML_TO_PLANTUML_H
#define SML_TO_PLANTUML_H
...
// TODO: グローバル変数になっている。クラスに押し込められないか?
...
void dump(const SM&, std::ostream& out) noexcept {
  out << "@startuml\n\n";
  dump_transitions<typename SM::transitions>::template func<0>(out);
  out << "\n@enduml\n";
}
