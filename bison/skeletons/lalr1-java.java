...
/**
 * A Bison parser, automatically generated from <tt>lalr1-java.y</tt>.
 *
...
class YYParser
{
  ...
  public enum SymbolKind
  {
    ...
    private static final SymbolKind[] values_ = {
      ...
      SymbolKind.S_type_decl,
      SymbolKind.S_type,
      SymbolKind.S_id_list,
      SymbolKind.S_expr
    };
  ...
  "ID", "'+'", "'-'", "'='", "';'", "'('", "')'", "','", "$accept",
  "type_decl", "type", "id_list", "expr", null
    };
  }
  ...
  public interface Lexer {
    ...
    /** Token TK_TYPE, to be returned by the scanner.  */
    static final int TK_TYPE = 258;
    /** Token DOTDOT, to be returned by the scanner.  */
    static final int DOTDOT = 259;
    /** Token ID, to be returned by the scanner.  */
    static final int ID = 260;
...
/* "lalr1-java.java":523  */
  ...
  public static final class Context {
    Context(YYParser parser, YYStack stack, SymbolKind token, Location loc) {
      yyparser = parser;
      yystack = stack;
      yytoken = token;
      yylocation = loc;
  ...
  private static final byte yytable_ninf_ = -11;
...
/* YYR2[RULE-NUM] -- Number of symbols on the right-hand side of rule RULE-NUM.  */
  ...
  private static final int YYLAST_ = 27;
