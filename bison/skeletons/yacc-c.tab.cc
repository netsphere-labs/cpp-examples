...
;
  ...
  int yystatus = yypull_parse (yyps);
...
;
  ...
  do {
    YYSTYPE yylval;
    int yychar = yylex (&yylval, &yylloc);
    yystatus = yypush_parse (yyps, yychar, &yylval, &yylloc);
...
#line 54 "yacc-c.yy"
                       { printf("id_list\n"); }
#line 1595 "yacc-c.tab.cc"
    break;

  case 4: /* type: expr DOTDOT expr  */
#line 55 "yacc-c.yy"
                     { printf("dotdot\n"); }
#line 1601 "yacc-c.tab.cc"
    break;


#line 1605 "yacc-c.tab.cc"
